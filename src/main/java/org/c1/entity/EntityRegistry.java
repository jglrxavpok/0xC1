...
public class EntityRegistry
{
    ...
    public static Entity createEntity(Level w, NBTCompoundTag entityData) throws ReflectiveOperationException, SecurityException
    {
        ...
        Constructor<? extends Entity> cons = type.getConstructor(Level.class);
