...
public class ParticleRenderer implements IParticleHandler
{
    ...
    public ParticleRenderer(int max)
    {
        ...
        map = new TextureMap(C1Client.getClient().getAssetsLoader(), new ResourceLocation("ourcraft", "textures/particles"));
    ...
    public void spawnParticle(String particleID, Level w, float x, float y, float z)
    {
    ...
    {
        spawnParticle(particleID, loc.getLevel(), loc.getX(), loc.getY(), loc.getZ(), life);
    }

    public void spawnParticle(String particleID, Level w, float x, float y, float z, long life)
    {
