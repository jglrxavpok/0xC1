...
public class GuiPopupElement extends GuiListSlot
{
    ...
    public GuiPopupElement(int id, String txt, FontRenderer fontRenderer)
    {
        ...
        {
            case 0:
                icon = C1Client.getClient().getRenderEngine().blocksAndItemsMap.get("blocks/dirt.png");
                break;
            case 1:
                icon = C1Client.getClient().getRenderEngine().blocksAndItemsMap.get("blocks/stone.png");
                break;
            case 2:
                icon = C1Client.getClient().getRenderEngine().blocksAndItemsMap.get("blocks/log_side.png");
                break;
            case 3:
                icon = C1Client.getClient().getRenderEngine().blocksAndItemsMap.get("blocks/grass_side.png");
                break;
            case 4:
                icon = C1Client.getClient().getRenderEngine().blocksAndItemsMap.get("blocks/rose.png");
                break;
        }
        setIcon(C1Client.getClient().getRenderEngine().blocksAndItemsMapLocation, icon);
    }
