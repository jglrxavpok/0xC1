...
public class GuiPanel extends GuiWidget
{
    ...
    protected C1Client        oc;
    protected FontRenderer    fontRenderer;
    protected boolean         forceDrawAll;
    private IGuiLayout        layout;

    public GuiPanel(int x, int y, int w, int h, C1Client oc, FontRenderer fontRenderer)
    {
        this(-1, x, y, w, h, oc, fontRenderer);
    }

    public GuiPanel(int id, int x, int y, int w, int h, C1Client oc, FontRenderer fontRenderer)
    {
        super(id, x, y, w, h);
