...
public class SpotLight extends PointLight {
    ...
    public SpotLight(Vec3f color, float intensity, Vec3f atten, float fov) {
        ...
        setShadowingData(new ShadowingData(new Mat4f().perspective(fov, 1.0f, 0.001f, getRange())));
        getShadowingData().setFlipCullFace(true);
        getShadowingData().setShadowMapSize(ShadowMapSize._1024x1024);
        // FIXME: make shadows work 
    }
